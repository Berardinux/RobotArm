...
if [ -n "$isControllerConnected" ]; then
    ...
    /usr/bin/python3 /home/berardinux/RobotArm/code/Python/Controller/src/Arm/IndividualControl/main.py &
    /usr/bin/python3 /home/berardinux/RobotArm/code/Python/Controller/src/ArmBase/main.py &
    /usr/bin/python3 /home/berardinux/RobotArm/code/Python/Controller/src/Hand/main.py &
    /usr/bin/python3 /home/berardinux/RobotArm/code/Python/Controller/src/Stepper/StepperController.py &
